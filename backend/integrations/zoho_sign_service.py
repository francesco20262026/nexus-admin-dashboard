...
class ZohoSignService:
    ...
    async def send_document_for_signature(self, pdf_bytes: bytes, file_name: str, client_name: str, client_email: str) -> Dict[str, Any]:
        """
        Upload the PDF and create a signature request for a single recipient.
        """
